...
export interface CoursePricing {
  ...
  duration: string;
  sessions: number; // Zoom sessions for Elite tier
}
/**
 * Complete pricing structure for all year levels and tiers
 */
export const PRICING: Record<YearLevel, CoursePricing> = {
  'year5-6': {
    standard: {
      upfront: 997,
      paymentPlan: {
 ...
 */
export function getPricing(yearLevel: YearLevel, tier: Tier): PricingDetails {
 ...
 */
export function getYearLevelName(yearLevel: YearLevel): string {
  const names: Record<YearLevel, string> = {
    'year5-6': 'Year 5/6',
    'year7': 'Year 7',
    'year8': 'Year 8',
    'year9': 'Year 9',
