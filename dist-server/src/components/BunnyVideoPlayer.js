...
export function BunnyVideoPlayer({ videoId, thumbnailUrl, className = "" }) {
    ...
    if (!videoId) {
        return (_jsx("div", { className: `relative w-full bg-gray-100 flex items-center justify-center ${className}`, style: { paddingBottom: "56.25%" }, children: _jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: _jsx("p", { className: "text-gray-500", children: "No video available" }) }) }));
    }
    return (_jsx("div", { className: `relative w-full ${className}`, style: { paddingBottom: "56.25%" }, children: _jsx("iframe", { ref: iframeRef, src: embedUrl, loading: "lazy", style: {
                position: "absolute",
                top: 0,
                left: 0,
                width: "100%",
                height: "100%",
                border: "none",
            }, allow: "accelerometer; gyroscope; autoplay; encrypted-media; picture-in-picture;", allowFullScreen: true, title: "Lesson Video" }) }));
}
