...
export function ImpersonationProvider({ children }) {
    ...
    const [impersonatedUserRole, setImpersonatedUserRole] = useState(null);
    const [impersonatedUserName, setImpersonatedUserName] = useState(null);
    const startImpersonation = (userId, role, name) => {
    ...
    return (_jsx(ImpersonationContext.Provider, { value: {
            impersonatedUserId,
