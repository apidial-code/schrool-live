...
interface Year8EliteEnrollmentFormProps {
  onSuccess?: (enrollmentId: string) => void;
}

export function Year8EliteEnrollmentForm({
  onSuccess,
}: Year8EliteEnrollmentFormProps) {
      ...
      <Card className="p-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 text-[#4169E1]">
            Year 8 Mathematics Excellence - Elite
          </h1>
            ...
            <div className="space-y-4">
              ...
              <div className={`flex items-start space-x-3 p-4 border-2 rounded-lg hover:bg-gray-50 cursor-pointer ${
                ...
                <Label htmlFor="upfront" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-lg font-bold text-[#4169E1] mt-1">$6,897.00</div>
                </Label>
              </div>
              ...
              <div className={`flex items-start space-x-3 p-4 border-2 rounded-lg hover:bg-gray-50 cursor-pointer ${
                ...
                <Label htmlFor="payment_plan" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-sm text-gray-700 mt-1">
                    <div>Deposit: $2,189.10</div>
                    <div>Monthly: $1,702.63 × 3 months</div>
                  </div>
                  <div className="text-lg font-bold text-[#4169E1] mt-1">Total: $7,297.00</div>
                </Label>
              </div>
            </div>
          </RadioGroup>
