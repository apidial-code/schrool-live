...
interface Year9EliteEnrollmentFormProps {
  onSuccess?: (enrollmentId: string) => void;
}

export function Year9EliteEnrollmentForm({
  onSuccess,
}: Year9EliteEnrollmentFormProps) {
      ...
      <Card className="p-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 text-[#4169E1]">
            Year 9 Mathematics Excellence - Elite
          </h1>
            ...
            <div className="space-y-4">
              ...
              <div className={`flex items-start space-x-3 p-4 border-2 rounded-lg hover:bg-gray-50 cursor-pointer ${
                ...
                <Label htmlFor="upfront" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-lg font-bold text-[#4169E1] mt-1">$7,897.00</div>
                </Label>
              </div>
              ...
              <div className={`flex items-start space-x-3 p-4 border-2 rounded-lg hover:bg-gray-50 cursor-pointer ${
                ...
                <Label htmlFor="payment_plan" className="flex-1 cursor-pointer">
                  ...
                  <div className="text-sm text-gray-700 mt-1">
                    <div>Deposit: $2,504.10</div>
                    <div>Monthly: $1,947.63 × 3 months</div>
                  </div>
                  <div className="text-lg font-bold text-[#4169E1] mt-1">Total: $8,347.00</div>
                </Label>
              </div>
            </div>
          </RadioGroup>
