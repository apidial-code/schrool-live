...
interface Year7EliteEnrollmentFormProps {
  onSuccess?: (enrollmentId: string) => void;
}

export function Year7EliteEnrollmentForm({
  onSuccess,
}: Year7EliteEnrollmentFormProps) {
      ...
      <Card className="p-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2 text-[#4169E1]">
            Year 7 Mathematics Excellence - Elite
          </h1>
