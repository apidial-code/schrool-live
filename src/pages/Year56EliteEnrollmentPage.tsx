    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">Year 5/6 Mathematics Excellence</p>
          <p className="text-gray-500 mt-2">This exclusive course includes 24+ weeks of personalised instruction and dedicated teacher support</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="font-semibold">24+ Weeks Duration</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Elite Program Enrollment - Year 5/6</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div>
                ...
                <RadioGroup value={formData.paymentOption} onValueChange={(val) => handleInputChange("paymentOption", val)}>
                  <div className="space-y-3">
                    <div className="border rounded-lg p-4 cursor-pointer hover:bg-blue-50" onClick={() => handleInputChange("paymentOption", "upfront")}>
                    ...
                    <div className="border rounded-lg p-4 cursor-pointer hover:bg-blue-50" onClick={() => handleInputChange("paymentOption", "plan")}>
                      <div className="flex items-start space-x-3">
              ...
              {/* Payment Details Section - Hidden from Agent View */}
