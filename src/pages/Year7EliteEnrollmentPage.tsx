...
import { CheckCircle2, Clock, Users, Video, MessageSquare, FileText, Eye, EyeOff } from "lucide-react";
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-50 to-indigo-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-500 mt-2">This exclusive course includes 32+ weeks of personalised instruction and dedicated teacher support</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="font-semibold">32+ Weeks Duration</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Elite Program Enrollment - Year 7</CardTitle>
              ...
              <div>
                ...
                <RadioGroup value={formData.paymentOption} onValueChange={(val) => handleInputChange("paymentOption", val)}>
                  <div className="space-y-3">
                    <div className="border rounded-lg p-4 cursor-pointer hover:bg-purple-50" onClick={() => handleInputChange("paymentOption", "upfront")}>
                    ...
                    <div className="border rounded-lg p-4 cursor-pointer hover:bg-purple-50" onClick={() => handleInputChange("paymentOption", "plan")}>
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            • 30% Deposit: $1,892.10 (due today)<br/>
                            • 3 Monthly Payments: $1,471.63 each<br/>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="acceptTerms" className="cursor-pointer text-sm">
                    I accept the <a href="/terms" className="text-purple-600 hover:underline">Terms of Service</a>
                  </Label>
                </div>
                <div className="flex items-start space-x-2">
                  <Checkbox
                  ...
                  <Label htmlFor="acceptPrivacy" className="cursor-pointer text-sm">
                    I accept the <a href="/privacy" className="text-purple-600 hover:underline">Privacy Policy</a>
                  </Label>
                </div>
              </div>
