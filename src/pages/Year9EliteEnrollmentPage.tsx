    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 to-pink-100 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600">Year 9 Mathematics Excellence</p>
          <p className="text-gray-500 mt-2">This exclusive course includes 39+ weeks of personalised instruction and dedicated teacher support</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-12">
          <Card>
            <CardContent className="pt-6">
              ...
              <p className="font-semibold">39+ Weeks Duration</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle>Elite Program Enrollment - Year 9</CardTitle>
              ...
              <div>
                ...
                <RadioGroup value={formData.paymentOption} onValueChange={(val) => handleInputChange("paymentOption", val)}>
                  <div className="space-y-3">
                    <div className="border rounded-lg p-4 cursor-pointer hover:bg-red-50" onClick={() => handleInputChange("paymentOption", "upfront")}>
                    ...
                    <div className="border rounded-lg p-4 cursor-pointer hover:bg-red-50" onClick={() => handleInputChange("paymentOption", "plan")}>
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 mt-1">
                            • 30% Deposit: $2,504.10 (due today)<br/>
                            • 3 Monthly Payments: $1,947.63 each<br/>
              ...
              <div className="space-y-3">
                <div className="flex items-start space-x-2">
                  ...
                  <Label htmlFor="acceptTerms" className="cursor-pointer text-sm">
                    I accept the <a href="/terms" className="text-red-600 hover:underline">Terms of Service</a>
                  </Label>
                </div>
                <div className="flex items-start space-x-2">
                  <Checkbox
                  ...
                  <Label htmlFor="acceptPrivacy" className="cursor-pointer text-sm">
                    I accept the <a href="/privacy" className="text-red-600 hover:underline">Privacy Policy</a>
                  </Label>
                </div>
              </div>
