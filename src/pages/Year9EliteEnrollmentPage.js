...
export default function Year9EliteEnrollmentPage() {
    ...
    return (_jsx("div", { className: "min-h-screen bg-gradient-to-br from-red-50 to-pink-100 py-12 px-4", children: _jsxs("div", { className: "max-w-4xl mx-auto", children: [_jsxs("div", { className: "text-center mb-12", children: [_jsx("div", { className: "inline-block bg-red-600 text-white px-4 py-2 rounded-full text-sm font-semibold mb-4", children: "Elite Program" }), _jsx("h1", { className: "text-4xl font-bold text-gray-900 mb-2", children: "Premium Math Course" }), _jsx("p", { className: "text-lg text-gray-600", children: "Year 9 Mathematics Excellence" }), _jsx("p", { className: "text-gray-500 mt-2", children: "This exclusive course includes 39+ weeks of personalised instruction and dedicated teacher support" })] }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4 mb-12", children: [_jsx(Card, { children: _jsxs(CardContent, { className: "pt-6", children: [_jsx(Clock, { className: "w-8 h-8 text-red-600 mb-2" }), _jsx("p", { className: "font-semibold", children: "39+ Weeks Duration" }), _jsx("p", { className: "text-sm text-gray-600", children: "Twice 1-hour weekly sessions" })] }) }), _jsx(Card, { children: _jsxs(CardContent, { className: "pt-6", children: [_jsx(Users, { className: "w-8 h-8 text-red-600 mb-2" }), _jsx("p", { className: "font-semibold", children: "Dedicated Teacher" }), _jsx("p", { className: "text-sm text-gray-600", children: "Personalised instruction and support" })] }) }), _jsx(Card, { children: _jsxs(CardContent, { className: "pt-6", children: [_jsx(Video, { className: "w-8 h-8 text-red-600 mb-2" }), _jsx("p", { className: "font-semibold", children: "Live Zoom Sessions" }), _jsx("p", { className: "text-sm text-gray-600", children: "Interactive online learning" })] }) })] }), _jsxs(Card, { className: "mb-8", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "What's Included" }) }), _jsx(CardContent, { children: _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [
